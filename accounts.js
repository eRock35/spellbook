// Multi-user accounts for Spellbook.
//
// Provenance: this is a FORK of trip-planner's accounts.js, taken 2026-09-22,
// because the access model is exactly the one Erik already settled on there —
// anyone may register, the free features open immediately, and anything that
// spends Anthropic tokens needs aiAccess === 'approved' from the admin. There
// was no reason to invent a second answer to a question already answered.
//
// It is a fork, NOT a shared file. The three older apps' auth modules diverged
// on purpose (santa-rosa-beach-trip is single-account; college-football-app has
// its own research allowlist), and this one will drift too. Do not "re-sync"
// any of them from another — copying the wrong direction would replace one
// app's gate with another app's, which is how a single-account app quietly
